...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        img_prefix='data/spermparsing/Training',
        classes=classes,
        ann_file='data/spermparsing/Training/annotations.json',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
     ...
     test=dict(
        type=dataset_type,
        img_prefix='data/spermparsing/Validation-2',
        classes=classes,
        ann_file='data/spermparsing/Validation-2/annotations.json',
        pipeline=test_pipeline))
