    ...
    def _load_masks(self, results):
        ...
        if self.poly2mask:
            ...
            gt_masks = [PolygonMasks(
                [self.process_polygons(polygons[i]) for polygons in gt_masks], h,
                w) for i in range(0,3)]
