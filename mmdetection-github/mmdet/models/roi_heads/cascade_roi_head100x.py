...
class CascadeRoIHead100x(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def __init__(self,
        ...
        super(CascadeRoIHead100x, self).__init__(
    ...
    def _mask_forward_train(self,
        ...
        loss_mask, loss_mask2  = self.mask_head.loss(mask_results['mask_pred'],
                                               mask_targets, pos_labels)

        mask_results.update(loss_mask=loss_mask, loss_mask2 = loss_mask2)
        #pdb.set_trace()
        return mask_results
                ...
                for i in range(num_imgs):
                    if det_bboxes[i].shape[0] == 0:
                        ...
                        segm_result = self.mask_head.get_seg_masks(
                            aug_mask, _bboxes[i], det_labels[i],
